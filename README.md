...
Once the `conda-forge` channel has been enabled, `verr` can be installed with:

```
conda install verr
```

It is possible to list all of the versions of `verr` available on your platform with:
